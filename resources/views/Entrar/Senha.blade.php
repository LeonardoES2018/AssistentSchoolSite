      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <form>
            ...
            <a class="btn btn-primary btn-block" href="index.html">Mudar senha</a>
          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="cadastro.html">Cadastrar-me</a>
            <a class="d-block small" href="index.html">Entrar</a>
          </div>
        </div>
      </div>
    </div>
